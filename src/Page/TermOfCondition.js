export const TermOfCondition = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Study All.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Study All, accessible from{" "}
            <a
              href="https://www.studyall.link"
              rel="external nofollow noreferrer"
              target="_blank"
            >
              https://www.studyall.link
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: hung.trinh_hungking@hcmut.edu.vn</p>
        </li>
        <li>
          <p>
